...
async function go() {
  let client = new MongoClient('mongodb+srv://todoAppUser:G$t.Er.d0ne@cluster0.soq49si.mongodb.net/TodoApp?retryWrites=true&w=majority')
...
function passwordProtected(req, res, next) {
  ...
  if (req.headers.authorization == "Basic bGVhcm46SmF2YVNjcmlwdA==") {
    next()
  } else {
